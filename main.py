    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return render_template_string(HTML_TEMPLATE, error=f"Error posting reaction: {response.text}")
        except Exception as e:
            return render_template_string(HTML_TEMPLATE, error=f"Something went wrong: {str(e)}")
